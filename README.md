...
Comments and inquiries should be sent to the GeoDCAT-AP WG mailing list: <a href="mailto:dcat_application_profile-geo@joinup.ec.europa.eu">dcat_application_profile-geo@joinup.ec.europa.eu</a>
